...
namespace Engine.Factories
{
    internal static class WorldFactory
    {
        internal static World CreateWorld()
        {
            ...
            newWorld.AddLocation(-2, -1, "Farmer's Field", "There are rows of corn growing here, with gaint rats hiding between them.", "FarmFields.png");
            newWorld.LocationAt(-2, -1).AddMonster(2, 100);

            newWorld.AddLocation(-1, -1, "Farmer's House", "This is the house of your neighbor, Farmer Ted.", "Farmhouse.png");
            ...
            newWorld.AddLocation(1, 0, "Town Gate", "There is a gate here, protecting the town from gaint spider webs.", "TownGate.png");
